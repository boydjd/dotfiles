...
tags = {
  names = { 0, "prog", "uni", "im" },
  layouts = { layouts[1], layouts[6], layouts[2], layouts[8] }
}
...
vicious.register(weatherwidget, vicious.widgets.weather, "${tempf}°", 1800, "KIAD")                                                           
...
clientbuttons = awful.util.table.join(
    ...
    awful.button({ }, 4, function (c) client.focus = c end),
    awful.button({ }, 5, function (c) client.focus = c end),
